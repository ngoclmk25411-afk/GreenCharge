...
create table Xe (
    ...
    MaNguoiDung varchar(10) not null foreign key references Khachhang(MaNguoiDung),
    MaChuanSac varchar(10) not null foreign key references CHUAN_SAC(MaChuanSac)
);
...
create table PhienSac (
    ...
    MaLichDat varchar(10) null foreign key references LichDatCho(MaLichDat),
    GioBatDau datetime not null,
...
create table HoaDon (
    ...
    MaPhien varchar(10) not null unique foreign key references PhienSac(MaPhien),
    MaNguoiDung varchar(10) not null foreign key references KhachHang(MaNguoiDung),
...
insert NGUOI_DUNG (MaNguoiDung, HoTen, Sdt, Email, VaiTro) values
